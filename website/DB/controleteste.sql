...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Nov-2020 às 21:50
...
(1, 1, 0, '50', '80', '0000-00-00', '0000-00-00', 0, 2, 1, 1);
...
(1, 'vinicius', 'vinicius@teste.com', 'e10adc3949ba59abbe56e057f20f883e', '2020-11-03', 1, NULL);
...
--
ALTER TABLE `produto`
  MODIFY `CodRefProduto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
