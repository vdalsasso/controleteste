...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Nov-2020 às 14:11
...
INSERT INTO `fabricante` (`idFabricante`, `NomeFabricante`, `CNPJFabricante`, `EmailFabricante`, `EnderecoFabricante`, `TelefoneFabricante`, `Ativo`, `Usuario_idUser`) VALUES
(1, 'dfgfdg', '45435', 'fgdfgfd@sdsad.com', 'redfgdfg', '46 32250000', 1, 1),
(2, 'dsfdsf', 'dfdsfdsf', 'dsfdsfdsf', 'dsfdsf', 'dsfdsfdsfd', 0, 1),
(3, 'a', 'aaaaaaaaaaa', 'aaaaaaaaaaaa', 'aaaaaaaaaaa', 'aaaaaaaaaaaaa', 0, 1),
(4, 'Brinks', 'dfg', 'gdfg', 'fdgfdg', 'fdgfdgfd', 0, 1),
(5, 'Mattelis 1', '06789384901', 'amttel@Mattel.com', 'Rua Mattelll, 300', '46 32250000', 1, 1),
(6, 'dfgfdg', '44455566677', 'fgdfgfd@sdsad.com', 'Rua Mattel, 300', '46 32250000', 1, 1),
(7, 'dfgfdg 34', '45435', 'fgdfgfd@sdsad.com', 'Rua Mattel, 300', '46 32250000', 0, 1);
...
(3, 'dsfdsf', 'dsfdsfdsfdsf', 'dsfdsf', 2, 1),
(4, 'aaaaaaaaaa', 'aaaaaaaaaaaaaaa', 'aaaaaaaaaaaa', 3, 1),
(5, 'gfdgfd', 'gfdgfdgf', 'fdgfdg', 4, 1),
(6, 'matel representador', '46 12344321', 'representante@mattel.com', 5, 1),
(7, '', '', '', 6, 1),
(8, '', '', '', 7, 1);
...
--
ALTER TABLE `produto`
  MODIFY `CodRefProduto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `representante`
--
ALTER TABLE `representante`
  MODIFY `idRepresentante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
